...
public class ConfirmLendUtil implements ActionListener{

	private String title = "确认借用设备";
	...
	private String[][] data2 = new String[1][4];
	private String[] columns1 = { "Lendno", "Eno","Ename", "Lcount","Returndate" };
	private String[] columns2 = {"LendName","LendPhone","username","Lenddate" };
	
	public ConfirmLendUtil() {
		// TODO Auto-generated constructor stub
	}
	
	public ConfirmLendUtil(LendEm lendEm) {
		Lendno = lendEm.getLendno();
		Ename = lendEm.getEname();
		username = lendEm.getUsername();
		Lcount = lendEm.getLcount();
		Returndate = lendEm.getReturndate();
		Lendname = lendEm.getLendname();
		Lendphone = lendEm.getLendphone();
		
		lendList = new ArrayList<LendEm>();
		new LendDao();
		lendList = LendDao.queryList();
		int size = lendList.size();
		for (int i = 0; i < size; i++) {
			LendEm em = lendList.get(i);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == yesButton) {
			MsgUtil.buyshowdb(LendDao.insert(Lendno,Lenddate,Eno,Lcount,Lendname,Lendphone,Returndate,username));
			//System.out.println(Lendno+" "+ Lenddate+" "+ Eno+" "+ Lcount+ " "+Lendname+ " "+Lendphone+" "+Returndate+" "+username+" ");
			close();
		}
...
//		LendEm lendEm = new LendEm("20220613002","玻璃棒",3,"小悦","15177776666","2022-06-13","Hanwei");
